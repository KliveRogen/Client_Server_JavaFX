...
win32:CONFIG(release, debug|release): TARGET = HYDR_REGVALVE
else:win32:CONFIG(debug, debug|release): TARGET = HYDR_REGVALVEd
TEMPLATE = lib

SOURCES += HYDR_REGVALVE.cpp

HEADERS += HYDR_REGVALVE.h \
    ../../include/IPort.h \
