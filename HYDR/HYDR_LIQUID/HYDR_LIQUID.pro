...
win32:CONFIG(release, debug|release): TARGET = HYDR_LIQUID
else:win32:CONFIG(debug, debug|release): TARGET = HYDR_LIQUIDd
TEMPLATE = lib

SOURCES += HYDR_LIQUID.cpp

HEADERS += HYDR_LIQUID.h \
    ../../include/IPort.h \
