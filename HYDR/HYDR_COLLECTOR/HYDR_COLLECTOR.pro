...
win32:CONFIG(release, debug|release): TARGET = HYDR_COLLECTOR
else:win32:CONFIG(debug, debug|release): TARGET = HYDR_COLLECTORd
TEMPLATE = lib

SOURCES += HYDR_COLLECTOR.cpp

HEADERS += HYDR_COLLECTOR.h \
    ../../include/IPort.h \
