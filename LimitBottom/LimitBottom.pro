...
win32:CONFIG(release, debug|release): TARGET = LimitBottom
else:win32:CONFIG(debug, debug|release): TARGET = LimitBottomd
TEMPLATE = lib

SOURCES += LimitBottom.cpp

HEADERS += LimitBottom.h \
    ../include/IPort.h \
