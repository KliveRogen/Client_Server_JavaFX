#ifndef TR_EXTRACTOR_H
#define TR_EXTRACTOR_H
...
class TR_EXTRACTOR : public CalcElement
{
...
private:
    ...
    IInputPort *IP_Mag, *IP_ExtPump, *IP_F200, *IP_F201, *IP_F222, *IP_V07,
               *IP_V06, *IP_V42, *IP_VTank, *IP_PumpTank, *IP_Debug;

    IOutputPort *OP_F210, *OP_F213, *OP_Debug;

    InertOneDelay IOD;
    bool NeedInitDelays;
};

#endif // TR_EXTRACTOR_H
