...
win32:CONFIG(release, debug|release): TARGET = GCS_FlowSeparator
else:win32:CONFIG(debug, debug|release): TARGET = GCS_FlowSeparatord
TEMPLATE = lib

SOURCES += GCS_FlowSeparator.cpp
