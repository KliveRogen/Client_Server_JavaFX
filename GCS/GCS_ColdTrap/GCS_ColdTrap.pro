...
win32:CONFIG(release, debug|release): TARGET = GCS_ColdTrap
else:win32:CONFIG(debug, debug|release): TARGET = GCS_ColdTrapd
TEMPLATE = lib

SOURCES += GCS_ColdTrap.cpp

HEADERS += GCS_ColdTrap.h \
    ../../include/IPort.h \
