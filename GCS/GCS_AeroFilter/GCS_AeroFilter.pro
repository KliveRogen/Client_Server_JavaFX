...
win32:CONFIG(release, debug|release): TARGET = GCS_AeroFilter
else:win32:CONFIG(debug, debug|release): TARGET = GCS_AeroFilterd
TEMPLATE = lib

SOURCES += GCS_AeroFilter.cpp

HEADERS += GCS_AeroFilter.h \
    ../../include/IPort.h \
