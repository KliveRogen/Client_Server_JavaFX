...
win32:CONFIG(release, debug|release): TARGET = GCS_SensorTemperature
else:win32:CONFIG(debug, debug|release): TARGET = GCS_SensorTemperatured
TEMPLATE = lib

SOURCES += GCS_SensorTemperature.cpp

HEADERS += GCS_SensorTemperature.h \
    ../../include/IPort.h \
