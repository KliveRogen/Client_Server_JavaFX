...
win32:CONFIG(release, debug|release): TARGET = GCS_SensorActivity
else:win32:CONFIG(debug, debug|release): TARGET = GCS_SensorActivityd
TEMPLATE = lib

SOURCES += GCS_SensorActivity.cpp

HEADERS += GCS_SensorActivity.h \
    ../../include/IPort.h \
