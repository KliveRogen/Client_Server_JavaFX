...
win32:CONFIG(release, debug|release): TARGET = GCS_SensorVolumeFlowRate
else:win32:CONFIG(debug, debug|release): TARGET = GCS_SensorVolumeFlowRated
TEMPLATE = lib

SOURCES += GCS_SensorVolumeFlowRate.cpp

HEADERS += GCS_SensorVolumeFlowRate.h \
    ../../include/IPort.h \
