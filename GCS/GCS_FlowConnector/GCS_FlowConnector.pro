...
win32:CONFIG(release, debug|release): TARGET = GCS_FlowConnector
else:win32:CONFIG(debug, debug|release): TARGET = GCS_FlowConnectord
TEMPLATE = lib

SOURCES += GCS_FlowConnector.cpp
