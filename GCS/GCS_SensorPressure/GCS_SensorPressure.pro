...
win32:CONFIG(release, debug|release): TARGET = GCS_SensorPressure
else:win32:CONFIG(debug, debug|release): TARGET = GCS_SensorPressured
TEMPLATE = lib

SOURCES += GCS_SensorPressure.cpp

HEADERS += GCS_SensorPressure.h \
    ../../include/IPort.h \
