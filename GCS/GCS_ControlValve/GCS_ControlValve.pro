...
win32:CONFIG(release, debug|release): TARGET = GCS_ControlValve
else:win32:CONFIG(debug, debug|release): TARGET = GCS_ControlValved
TEMPLATE = lib

SOURCES += GCS_ControlValve.cpp

HEADERS += GCS_ControlValve.h \
    ../../include/IPort.h \
