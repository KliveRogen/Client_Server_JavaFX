...
win32:CONFIG(release, debug|release): TARGET = GCS_SensorActivityDevice
else:win32:CONFIG(debug, debug|release): TARGET = GCS_SensorActivityDeviced
TEMPLATE = lib

SOURCES += GCS_SensorActivityDevice.cpp

HEADERS += GCS_SensorActivityDevice.h \
    ../../include/IPort.h \
