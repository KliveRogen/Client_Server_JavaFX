...
win32:CONFIG(release, debug|release): TARGET = CMN_VectorSelector
else:win32:CONFIG(debug, debug|release): TARGET = CMN_VectorSelectord
TEMPLATE = lib

SOURCES += CMN_VectorSelector.cpp

HEADERS += CMN_VectorSelector.h \
    ../include/IPort.h \
