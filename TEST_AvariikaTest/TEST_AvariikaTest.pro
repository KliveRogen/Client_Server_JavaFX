...
win32:CONFIG(release, debug|release): TARGET = TEST_AvariikaTest
else:win32:CONFIG(debug, debug|release): TARGET = TEST_AvariikaTestd
TEMPLATE = lib

SOURCES += TEST_AvariikaTest.cpp

HEADERS += TEST_AvariikaTest.h \
    ../include/IPort.h \
