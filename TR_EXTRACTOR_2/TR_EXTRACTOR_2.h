#ifndef TR_EXTRACTOR_2_H
#define TR_EXTRACTOR_2_H
...
class TR_EXTRACTOR_2 : public CalcElement
{
...
private:
    ...
    IInputPort *IP_Mag, *IP_ExtPump, *IP_F210, *IP_F60A, *IP_V07,
               *IP_V06, *IP_V42, *IP_VTank, *IP_PumpTank, *IP_Debug;

    IOutputPort *OP_F220, *OP_F222, *OP_Debug;

    InertOneDelay IOD;
    bool NeedInitDelays;
};

#endif // TR_EXTRACTOR_2_H
