...
win32:CONFIG(release, debug|release): TARGET = MP_CR_InitTank
else:win32:CONFIG(debug, debug|release): TARGET = MP_CR_InitTankd
TEMPLATE = lib

SOURCES += MP_CR_InitTank.cpp

HEADERS += MP_CR_InitTank.h \
    ../include/IPort.h \
