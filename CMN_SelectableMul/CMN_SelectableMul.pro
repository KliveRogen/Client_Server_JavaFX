...
win32:CONFIG(release, debug|release): TARGET = CMN_SelectableMul
else:win32:CONFIG(debug, debug|release): TARGET = CMN_SelectableMuld
TEMPLATE = lib

SOURCES += CMN_SelectableMul.cpp

HEADERS += CMN_SelectableMul.h \
    ../include/IPort.h \
