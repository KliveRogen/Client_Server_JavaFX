...
win32:CONFIG(release, debug|release): TARGET = TR_VAPE_10T_AD3750
else:win32:CONFIG(debug, debug|release): TARGET = TR_VAPE_10T_AD3750d
TEMPLATE = lib

SOURCES += TR_VAPE_10T_AD3750.cpp \
    ../TR_VAPE_CALC/tr_vape_calc.cpp

HEADERS += TR_VAPE_10T_AD3750.h \
    ../../include/IPort.h \
