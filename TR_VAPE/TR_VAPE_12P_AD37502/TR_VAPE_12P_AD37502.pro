...
win32:CONFIG(release, debug|release): TARGET = TR_VAPE_12P_AD37502
else:win32:CONFIG(debug, debug|release): TARGET = TR_VAPE_12P_AD37502d
TEMPLATE = lib

SOURCES += TR_VAPE_12P_AD37502.cpp \
    ../TR_VAPE_CALC/tr_vape_calc.cpp

HEADERS += TR_VAPE_12P_AD37502.h \
    ../../include/IPort.h \
