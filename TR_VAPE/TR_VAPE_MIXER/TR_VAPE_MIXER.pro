...
win32:CONFIG(release, debug|release): TARGET = TR_VAPE_MIXER
else:win32:CONFIG(debug, debug|release): TARGET = TR_VAPE_MIXERd
TEMPLATE = lib

SOURCES += TR_VAPE_MIXER.cpp \
    ../TR_VAPE_CALC/tr_vape_calc.cpp

HEADERS += TR_VAPE_MIXER.h \
    ../../include/IPort.h \
