...
win32:CONFIG(release, debug|release): TARGET = TR_VAPE_14T_AD8444
else:win32:CONFIG(debug, debug|release): TARGET = TR_VAPE_14T_AD8444d
TEMPLATE = lib

SOURCES += TR_VAPE_14T_AD8444.cpp \
    ../TR_VAPE_CALC/tr_vape_calc.cpp

HEADERS += TR_VAPE_14T_AD8444.h \
    ../../include/IPort.h \
