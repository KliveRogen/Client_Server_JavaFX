...
win32:CONFIG(release, debug|release): TARGET = TR_VAPE_11P_AD37501
else:win32:CONFIG(debug, debug|release): TARGET = TR_VAPE_11P_AD37501d
TEMPLATE = lib

SOURCES += TR_VAPE_11P_AD37501.cpp \
    ../TR_VAPE_CALC/tr_vape_calc.cpp

HEADERS += TR_VAPE_11P_AD37501.h \
    ../../include/IPort.h \
