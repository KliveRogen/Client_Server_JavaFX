...
win32:CONFIG(release, debug|release): TARGET = TR_VAPE_16S_IS
else:win32:CONFIG(debug, debug|release): TARGET = TR_VAPE_16S_ISd
TEMPLATE = lib

SOURCES += TR_VAPE_16S_IS.cpp \
    ../TR_VAPE_CALC/tr_vape_calc.cpp

HEADERS += TR_VAPE_16S_IS.h \
    ../../include/IPort.h \
