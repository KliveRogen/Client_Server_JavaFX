...
win32:CONFIG(release, debug|release): TARGET = TR_VAPE_02P_AD37421
else:win32:CONFIG(debug, debug|release): TARGET = TR_VAPE_02P_AD37421d
TEMPLATE = lib

SOURCES += TR_VAPE_02P_AD37421.cpp \
    ../TR_VAPE_CALC/tr_vape_calc.cpp

HEADERS += TR_VAPE_02P_AD37421.h \
    ../../include/IPort.h \
