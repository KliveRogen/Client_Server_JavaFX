#include "TR_VAPE_02P_AD37421.h"

TR_VAPE_02P_AD37421::TR_VAPE_02P_AD37421()
{
	// Расчетный тип блока
...
void TR_VAPE_02P_AD37421::setDataNames()
{
...
bool TR_VAPE_02P_AD37421::init(std::string &error, double h)
{
    setDataNames();
    //инициализации
...
bool TR_VAPE_02P_AD37421::process(double t, double h, std::string &error)
{
...
ICalcElement *Create()
{
    return new TR_VAPE_02P_AD37421();
}

void Release(ICalcElement *block)
{
    if(block->type() == "TR_VAPE_02P_AD37421") delete block;
}

std::string Type()
{
    return "TR_VAPE_02P_AD37421";
}
