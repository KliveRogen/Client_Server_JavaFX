...
win32:CONFIG(release, debug|release): TARGET = TR_VAPE_13T_AD8445
else:win32:CONFIG(debug, debug|release): TARGET = TR_VAPE_13T_AD8445d
TEMPLATE = lib

SOURCES += TR_VAPE_13T_AD8445.cpp \
    ../TR_VAPE_CALC/tr_vape_calc.cpp

HEADERS += TR_VAPE_13T_AD8445.h \
    ../../include/IPort.h \
