...
win32:CONFIG(release, debug|release): TARGET = TR_VAPE_03P_AD37422
else:win32:CONFIG(debug, debug|release): TARGET = TR_VAPE_03P_AD37422d
TEMPLATE = lib

SOURCES += TR_VAPE_03P_AD37422.cpp \
    ../TR_VAPE_CALC/tr_vape_calc.cpp

HEADERS += TR_VAPE_03P_AD37422.h \
    ../include/IPort.h \
    ../../include/IPort.h \
