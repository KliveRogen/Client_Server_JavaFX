...
win32:CONFIG(release, debug|release): TARGET = TR_VAPE_04H_AN3718
else:win32:CONFIG(debug, debug|release): TARGET = TR_VAPE_04H_AN3718d
TEMPLATE = lib

SOURCES += TR_VAPE_04H_AN3718.cpp \
    ../TR_VAPE_CALC/tr_vape_calc.cpp

HEADERS += TR_VAPE_04H_AN3718.h \
    ../../include/IPort.h \
