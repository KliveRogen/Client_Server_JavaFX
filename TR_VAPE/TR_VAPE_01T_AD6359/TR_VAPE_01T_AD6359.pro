...
win32:CONFIG(release, debug|release): TARGET = TR_VAPE_01T_AD6359
else:win32:CONFIG(debug, debug|release): TARGET = TR_VAPE_01T_AD6359d
TEMPLATE = lib

SOURCES += TR_VAPE_01T_AD6359.cpp \
    ../TR_VAPE_CALC/tr_vape_calc.cpp

HEADERS += TR_VAPE_01T_AD6359.h \
    ../../include/IPort.h \
