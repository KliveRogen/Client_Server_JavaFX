...
win32:CONFIG(release, debug|release): TARGET = TR_VAPE_05V_AD3746
else:win32:CONFIG(debug, debug|release): TARGET = TR_VAPE_05V_AD3746d
TEMPLATE = lib

SOURCES += TR_VAPE_05V_AD3746.cpp \
    ../TR_VAPE_CALC/tr_vape_calc.cpp

HEADERS += TR_VAPE_05V_AD3746.h \
    ../../include/IPort.h \
