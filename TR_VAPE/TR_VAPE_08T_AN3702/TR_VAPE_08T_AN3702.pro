...
win32:CONFIG(release, debug|release): TARGET = TR_VAPE_08T_AN3702
else:win32:CONFIG(debug, debug|release): TARGET = TR_VAPE_08T_AN3702d
TEMPLATE = lib

SOURCES += TR_VAPE_08T_AN3702.cpp \
    ../TR_VAPE_CALC/tr_vape_calc.cpp

HEADERS += TR_VAPE_08T_AN3702.h \
    ../../include/IPort.h \
