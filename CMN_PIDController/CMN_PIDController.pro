...
win32:CONFIG(release, debug|release): TARGET = CMN_PIDController
else:win32:CONFIG(debug, debug|release): TARGET = CMN_PIDControllerd
TEMPLATE = lib

SOURCES += CMN_PIDController.cpp

HEADERS += CMN_PIDController.h \
    ../include/IPort.h \
