...
win32:CONFIG(release, debug|release): TARGET = CMN_NormallyOpenContact
else:win32:CONFIG(debug, debug|release): TARGET = CMN_NormallyOpenContactd
TEMPLATE = lib

SOURCES += CMN_NormallyOpenContact.cpp

HEADERS += CMN_NormallyOpenContact.h \
    ../include/IPort.h \
