...
win32:CONFIG(release, debug|release): TARGET = MP_Ref_TankColl6310
else:win32:CONFIG(debug, debug|release): TARGET = MP_Ref_TankColl6310d
TEMPLATE = lib

SOURCES += MP_Ref_TankColl6310.cpp

HEADERS += MP_Ref_TankColl6310.h \
    ../../include/IPort.h \
