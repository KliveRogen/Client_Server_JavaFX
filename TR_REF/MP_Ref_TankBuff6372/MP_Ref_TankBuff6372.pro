...
win32:CONFIG(release, debug|release): TARGET = MP_Ref_TankBuff6372
else:win32:CONFIG(debug, debug|release): TARGET = MP_Ref_TankBuff6372d
TEMPLATE = lib

SOURCES += MP_Ref_TankBuff6372.cpp

HEADERS += MP_Ref_TankBuff6372.h \
    ../../include/IPort.h \
