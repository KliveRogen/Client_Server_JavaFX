...
win32:CONFIG(release, debug|release): TARGET = MFR_VortexLayer
else:win32:CONFIG(debug, debug|release): TARGET = MFR_VortexLayerd
TEMPLATE = lib

SOURCES += MFR_VortexLayer.cpp

HEADERS += MFR_VortexLayer.h \
    ../../include/IPort.h \
