...
win32:CONFIG(release, debug|release): TARGET = LimitTopBottom
else:win32:CONFIG(debug, debug|release): TARGET = LimitTopBottomd
TEMPLATE = lib

SOURCES += LimitTopBottom.cpp

HEADERS += LimitTopBottom.h \
    ../include/IPort.h \
