...
win32:CONFIG(release, debug|release): TARGET = MP_CR_Syringe
else:win32:CONFIG(debug, debug|release): TARGET = MP_CR_Syringed
TEMPLATE = lib

SOURCES += MP_CR_Syringe.cpp

HEADERS += MP_CR_Syringe.h \
    ../include/IPort.h \
