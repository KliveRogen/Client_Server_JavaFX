...
win32:CONFIG(release, debug|release): TARGET = MP_CR_PeristalticPump
else:win32:CONFIG(debug, debug|release): TARGET = MP_CR_PeristalticPumpd
TEMPLATE = lib

SOURCES += MP_CR_PeristalticPump.cpp

HEADERS += MP_CR_PeristalticPump.h \
    ../include/IPort.h \
