...
win32:CONFIG(release, debug|release): TARGET = Differentiation
else:win32:CONFIG(debug, debug|release): TARGET = Differentiationd

TEMPLATE = lib

SOURCES += Differentiation.cpp

HEADERS += Differentiation.h \
    ../include/IPort.h \
