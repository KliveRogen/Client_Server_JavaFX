...
win32:CONFIG(release, debug|release): TARGET = MP_EX_EXTRACTOR
else:win32:CONFIG(debug, debug|release): TARGET = MP_EX_EXTRACTORd
TEMPLATE = lib

SOURCES += MP_EX_EXTRACTOR.cpp

HEADERS += MP_EX_EXTRACTOR.h \
    ../include/IPort.h \
