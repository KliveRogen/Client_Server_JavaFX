...
win32:CONFIG(release, debug|release): TARGET = Multiconst
else:win32:CONFIG(debug, debug|release): TARGET = Multiconstd
TEMPLATE = lib

SOURCES += Multiconst.cpp

HEADERS += Multiconst.h \
    ../include/IPort.h \
