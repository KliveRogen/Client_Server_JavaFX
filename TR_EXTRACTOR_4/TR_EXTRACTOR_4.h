#ifndef TR_EXTRACTOR_4_H
#define TR_EXTRACTOR_4_H
...
class TR_EXTRACTOR_4 : public CalcElement
{
...
private:
    ...
    IInputPort *IP_Mag, *IP_ExtPump, *IP_F230, *IP_F59, *IP_V07,
               *IP_V06, *IP_V42, *IP_VTank, *IP_PumpTank, *IP_Debug;

    IOutputPort *OP_F200, *OP_F247, *OP_Debug;

    InertOneDelay IOD;
    bool NeedInitDelays;
};

#endif // TR_EXTRACTOR_4_H
