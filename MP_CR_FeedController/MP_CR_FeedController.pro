...
win32:CONFIG(release, debug|release): TARGET = MP_CR_FeedController
else:win32:CONFIG(debug, debug|release): TARGET = MP_CR_FeedControllerd
TEMPLATE = lib

SOURCES += MP_CR_FeedController.cpp

HEADERS += MP_CR_FeedController.h \
    ../include/IPort.h \
