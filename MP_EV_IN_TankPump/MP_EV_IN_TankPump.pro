...
win32:CONFIG(release, debug|release): TARGET = MP_EV_IN_TankPump
else:win32:CONFIG(debug, debug|release): TARGET = MP_EV_IN_TankPumpd
TEMPLATE = lib

SOURCES += MP_EV_IN_TankPump.cpp

HEADERS += MP_EV_IN_TankPump.h \
    ../include/IPort.h \
