...
win32:CONFIG(release, debug|release): TARGET = MP_VOL_VOLOX
else:win32:CONFIG(debug, debug|release): TARGET = MP_VOL_VOLOXd
TEMPLATE = lib

SOURCES += MP_VOL_VOLOX.cpp

HEADERS += MP_VOL_VOLOX.h \
    ../include/IPort.h \
